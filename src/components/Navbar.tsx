      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            <button onClick={handleRandom} className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.nav.random}>
              <Shuffle className="w-5 h-5 text-orange-500" />
            </button>
            <Link href="/activity" className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.nav.activity}>
              <Activity className="w-5 h-5 text-cyan-500" />
            </Link>
            <Link href="/leaderboard" className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.nav.leaderboard}>
              <Trophy className="w-5 h-5 text-yellow-500" />
            </Link>
            <Link href="/stats" className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.nav.stats}>
            ...
            {mounted && (
              <button onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={theme === 'dark' ? '切换到亮色模式' : '切换到暗色模式'}>
                {theme === 'dark' ? <Sun className="w-5 h-5 text-yellow-400" /> : <Moon className="w-5 h-5 text-gray-600" />}
              </button>
            )}
            {session ? (
              <>
                <Link href="/notifications" className="relative p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.nav.notifications}>
                ...
                <Link href="/bookmarks" className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.nav.bookmarks}>
                ...
                <Link href="/bury" className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white rounded-lg transition-colors">
                  ...
                  <span className="hidden lg:inline">{t.nav.bury}</span>
                </Link>
          ...
          >
            <div className="px-4 py-3 space-y-1">
              <button onClick={handleRandom} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-300 w-full">
                <Shuffle className="w-5 h-5 text-orange-500" />
                <span className="text-sm">{t.nav.random}</span>
              </button>
              <Link href="/activity" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-300">
                <Activity className="w-5 h-5 text-cyan-500" />
                <span className="text-sm">{t.nav.activity}</span>
              </Link>
              <Link href="/leaderboard" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-300">
                <Trophy className="w-5 h-5 text-yellow-500" />
                <span className="text-sm">{t.nav.leaderboard}</span>
              </Link>
              <Link href="/stats" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-300">
                <BarChart3 className="w-5 h-5 text-green-500" />
                <span className="text-sm">{t.nav.stats}</span>
              </Link>
              ...
              {session ? (
                <>
                  ...
                  <Link href="/bury" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg bg-purple-600 text-white">
                    ...
                    <span className="text-sm">{t.nav.bury}</span>
                  </Link>
                  ...
                  <Link href="/bookmarks" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-300">
                    <Bookmark className="w-5 h-5 text-amber-500" />
                    <span className="text-sm">{t.nav.bookmarks}</span>
                  </Link>
                  <Link href="/my-graveyard" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-sm">{t.nav.myGraveyard}</span>
                  </Link>
